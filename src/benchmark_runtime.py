...
def copy_report_assets(dirs: dict[str, Path], config: dict) -> None:
    ...
    for src_name, dst_name in {
        "runtime_ms_per_image.png": "fig_34_runtime_ms_per_image.png",
        "runtime_images_per_second.png": "fig_35_runtime_images_per_second.png",
    }.items():
    ...
    if table.exists():
        shutil.copy2(table, report_table_dir / "table_13_runtime_summary.csv")
