...
def copy_report_assets(dirs: dict[str, Path], config: dict) -> None:
    ...
    figure_map = {
        "fgsm_jpeg_quality_curve.png": "fig_34_fgsm_jpeg_quality_curve.png",
        "pgd_jpeg_quality_curve.png": "fig_35_pgd_jpeg_quality_curve.png",
        "jpeg_quality_eps003_bar.png": "fig_36_jpeg_quality_eps003_bar.png",
        "jpeg_clean_accuracy_cost.png": "fig_37_jpeg_clean_accuracy_cost.png",
    }
    ...
    for src_name, dst_name in {
        "fgsm_eps_0.03_jpeg_quality_grid.png": "fig_38_fgsm_jpeg_quality_examples.png",
        "pgd_eps_0.03_jpeg_quality_grid.png": "fig_39_pgd_jpeg_quality_examples.png",
    }.items():
    ...
    if metrics.exists():
        shutil.copy2(metrics, report_table_dir / "table_14_jpeg_quality_metrics.csv")
